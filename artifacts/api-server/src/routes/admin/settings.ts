...
const DEFAULT_SETTINGS = [
  ...
  { key: "email_primary", value: "consult@legalfilingindia.com" },
  { key: "email_secondary", value: "info@legalfilingindia.com" },
  ...
  // Firm details for PDFs (invoice / quotation print)
  { key: "firm_name",       value: "Legal Filing India" },
  { key: "firm_tagline",    value: "Advocates & Legal Consultants" },
  { key: "firm_address",    value: "123, Legal Complex, Connaught Place, New Delhi — 110001" },
  { key: "firm_phone",      value: "+91 98765 43210" },
  { key: "firm_email",      value: "info@legalfilingindia.com" },
  { key: "firm_gstin",      value: "07AABCV1234P1Z5" },
  { key: "firm_pan",        value: "AABCV1234P" },
  { key: "bank_name",       value: "HDFC Bank, New Delhi" },
  { key: "bank_account_no", value: "12345678901234" },
  { key: "bank_ifsc",       value: "HDFC0001234" },
  { key: "bank_upi",        value: "legalfilingindia@hdfcbank" },
