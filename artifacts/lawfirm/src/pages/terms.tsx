...
const sections = [
  { title: "1. Acceptance of Terms", content: `By accessing or using the website and services of Legal Filing India India's Trusted Filing Platform ("Legal Filing India", "we", "us", or "our"), you agree to be bound by these Terms of Use ("Terms"). If you do not agree to these Terms, please do not use our services.\n\nThese Terms apply to all visitors, users, and clients of our website located at legalfilingindia.com and any associated sub-domains, applications, or services.` },
  { title: "2. No Attorney-Client Relationship", content: `IMPORTANT: Use of this website, submission of contact forms, or any communication via this website does not create an attorney-client relationship between you and Legal Filing India or any of its lawyers.\n\nAn attorney-client relationship is established only when:\n• You have signed a formal engagement letter or retainer agreement with Legal Filing India\n• Legal Filing India has confirmed in writing that it is representing you in a specific legal matter\n\nInformation shared before a formal engagement is not protected by attorney-client privilege.` },
  { title: "3. Not Legal Advice", content: `The information provided on this website, including articles, guides, FAQs, and service descriptions, is for general informational purposes only. It does not constitute legal advice and should not be relied upon as such.\n\nLegal outcomes depend on specific facts, applicable laws, and jurisdiction. Always consult a qualified lawyer before making any legal decisions. Legal Filing India expressly disclaims liability for any action taken or not taken based on information on this website.` },
  { title: "4. Services", content: `Legal Filing India provides legal consultancy, documentation, representation, and related services subject to the terms of individual engagement agreements. The scope, fees, timelines, and conditions of each service are governed by the specific engagement letter or service agreement entered into with each client.\n\nService availability may vary by state, jurisdiction, and applicable regulations. Legal Filing India reserves the right to decline any engagement at its sole discretion.` },
  ...
  { title: "6. Intellectual Property", content: `All content on this website, including text, graphics, logos, icons, images, legal guides, and software, is the property of Legal Filing India and is protected by Indian and international copyright, trademark, and other intellectual property laws.\n\nYou may view and print pages from this website for personal, non-commercial use. Any other use — including reproduction, modification, distribution, or commercial exploitation — requires prior written consent from Legal Filing India` },
...
export default function TermsOfUse() {
  return (
    <>
      <Helmet>
        <title>Terms of Use — Legal Filing India</title>
        <meta name="description" content="Legal Filing India Terms of Use — please read before using our legal services website." />
      </Helmet>
