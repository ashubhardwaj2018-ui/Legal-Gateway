...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy — Vakil & Co.</title>
        <meta name="description" content="Vakil & Co. Privacy Policy — How we collect, use, and protect your personal information." />
      </Helmet>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-3xl px-4">
          <div className="bg-[#0f2044]/5 border border-[#0f2044]/10 rounded-2xl p-5 mb-10 text-sm text-gray-600">
            <strong className="text-[#0f2044]">Summary:</strong> Vakil & Co. is committed to protecting your privacy. We collect only the data needed to provide legal services, never sell your information, protect attorney-client privilege, and give you control over your data. For full details, read the policy below.
          </div>
